...
ADRs are numbered with a four-digit zero-padded prefix (e.g. `0001-my-decision.md`). Once accepted, an ADR is never edited — superseded decisions get a new ADR that references the one it replaces.
